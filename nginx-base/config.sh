...
luajit2_version=2.1-20260311
# https://github.com/openresty/stream-lua-nginx-module/tags
stream_lua_nginx_module_version=0.0.18RC2
...
nginx_lua_resty_core_version=0.1.33rc2
